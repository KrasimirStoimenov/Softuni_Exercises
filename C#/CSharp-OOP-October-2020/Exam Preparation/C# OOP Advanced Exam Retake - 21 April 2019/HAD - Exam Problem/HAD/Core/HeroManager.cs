...
namespace HAD.Core
{
    public class HeroManager : IManager
    {
        ...
        public string AddRecipe(IList<string> arguments)
        {
            ...
            var items = arguments.Skip(7).ToArray();

            IRecipe recipe = new RecipeItem(recipeName, strengthBonus, agilityBonus, intelligenceBonus, hitPointsBonus, damageBonus, items);
